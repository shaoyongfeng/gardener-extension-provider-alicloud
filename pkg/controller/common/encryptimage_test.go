...
var _ = Describe("Encrypt Image tools", func() {
	DescribeTable("#UseEncryptedSystemDisk",
		...
		Entry("corev1beta1 image with nil Encryption value uses encryption", &gcorev1beta1.Volume{}, true, false),
		...
		Entry("extensionsv1alpha1 image with nil Encryption value uses encryption", &gcorev1beta1.Volume{}, true, false),
